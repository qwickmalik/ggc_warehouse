...
<?php echo $this->Form->create('TrialBalance', array("url" => array('controller' => 'Reports', 'action' => 'trialBalance'))); ?>
            ...
            <td>
                ...
                <table class="table table-striped">
                    ...
                    <tr style="background: #CDEEFE;">
                        <td align="right" colspan="2" style="font-weight: bold;">TOTALS</td>
