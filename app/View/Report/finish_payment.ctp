...
<table id="report_content" width="100%" align="left" cellspacing="0" cellpadding="5" border="0">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                    ...
                    <p style='font-weight: bold; font-size: 16px; text-align: left;'>
                        FINISH PAYMENT REPORT <br/>from <?php echo $sdate; ?> - <?php echo $edate; ?>
                    </p>
                </div>
    ...
    <tr style="background: #eaeaea;" id="dateRow">
        ...
        <td align="left" valign="top" colspan="7">
            ...
            <?php echo $this->Form->create('Order', array("url" => array('controller' => 'Reports', 'action' => 'finishPayment'))); ?>
            <table cellspacing="10" cellpadding="0" width="100%" border="0" style="">
                ...
                <tr>
                    ...
                    <td  align="right">
                        <?php
                        echo $this->Form->button('View', array("type" => "submit", "class" => "btn btn-md btn-success", "id" => "balinterrimBTN"));
                        ?>
                    </td>
                </tr>
            </table>
