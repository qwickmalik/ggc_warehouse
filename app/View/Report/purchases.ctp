...
<table id="report_content" width="100%" align="left" cellspacing="0" cellpadding="5" border="0">
        ...
        <td colspan="7" align="left">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                    ...
                    <p style='font-weight: bold; font-size: 16px; text-align: left;'>PURCHASES REPORT <br />from <?php echo $sdate; ?> - <?php echo $edate; ?></p>
    ...
    <tr style="background: #eaeaea;" id="dateRow">
        ...
        <td align="left" valign="top" colspan="6">
            ...
            <?php echo $this->Form->create('OrdersItem', array("url" => array('controller' => 'Reports', 'action' => 'purchases'))); ?>
        ...
        <td colspan="6">
            <table class="table table-striped">
                <tr>
                    ...
                    <th align="right" valign="top" style="border-bottom: solid 2px Gray;"><?php echo $this->Paginator->sort('selling_price', 'Cash Price'); ?></th>
                    <th align="right" valign="top" style="border-bottom: solid 2px Gray;"><?php echo $this->Paginator->sort('hp_price', 'Amount'); ?></th>
                    <th align="right" valign="top" style="border-bottom: solid 2px Gray;"><?php echo $this->Paginator->sort('order_date', 'Entry Date'); ?></th>
                </tr>
                        ...
                        <tr>
                            ...
                            <td align="right" valign="top" style="border-bottom: solid 1px #ffffff; background: #eaeaea; font-weight: bold;"><?php
                                if (isset($each_item[0]['total'])) {
                                    echo $shopCurrency . ' ' . round($each_item[0]['total'], 2);
                                }
                                ?></td>
                            <td align="left" valign="top" style="border-bottom: solid 1px #ffffff; background: #eaeaea; font-weight: bold;">&nbsp;</td>
                        </tr>
