...
<!-- Content starts here -->
    ...
    <?php echo $this->Form->create('Order', array('enctype' => 'multipart/form-data', "url" => array('controller' => 'Reports', 'action' => 'searchOrder'), "inputDefaults" => array('div' => false))); ?>
    <table border="0" width="100%" cellspacing="0" cellpadding="5" align="left">
        <tr>
            <td align="center" width="33%" style="font-size: 18px; color: gray; font-weight: bold;">&nbsp;</td>
            <td align="center" width="34%" style="font-size: 18px; color: gray; font-weight: bold;">&nbsp;</td>
            <td align="center" width="33%" style="font-size: 18px; color: gray; font-weight: bold;">&nbsp;</td>
        </tr>
        <tr>
            <td align="center" width="33%" style="font-size: 18px; color: gray; font-weight: bold;">&nbsp;</td>
...
//                echo $this->Form->button('Search', array("type" => "submit", "id" => "cred_save", "class" => "button_blue"));
                ...
                echo $this->Form->input('search', array('size'=> 50, 'name' => 'order_search','label'=>false,'value' => (isset($cust['Customer']['full_name']) ? $cust['Customer']['full_name'] : '' )));
                echo $this->Form->button('Search', array("type" => "submit", "class" => "btn btn-md btn-primary"));
                ?>
                &nbsp;
                <?php echo $this->Html->link('Proceed',"/Reports/clearOrdersearchSessions",array("class" => 'btn btn-md btn-success')); ?>
