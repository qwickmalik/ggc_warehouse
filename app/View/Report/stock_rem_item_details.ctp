...
<table width="100%" align="left" cellspacing="0" cellpadding="5" border="0" id="report_content">
    ...
    <tr style="background: #eaeaea;" id="dateRow">
        ...
        <td align="left" valign="top" colspan="7">
            ...
            <?php echo $this->Form->create('Item', array("url" => array('controller' => 'Reports', 'action' => 'stockRemItemDetails'))); ?>
            <table cellspacing="10" cellpadding="0" width="100%" border="0" style="">
                ...
                <tr>
                    ...
                    <td  align="right">
                        <?php
                        echo $this->Form->button('View', array("type" => "submit", "class" => "btn btn-md btn-success", "id" => "stockrep"));
                        ?>
                    </td>
                </tr>
            </table>
        ...
        <td colspan="7">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th align="left" valign="top" style="border-bottom: solid 2px Gray;"><?php echo $this->Paginator->sort('serialno', 'Serial No.'); ?></th>
                    ...
                    <th align="left" valign="top" style="border-bottom: solid 2px Gray;"><?php echo $this->Paginator->sort('cost_price', 'Cost Price'); ?></th>
                    ...
                    foreach ($sales as $each_item):
                        ...
                        <tr>
                            ...
                            <td align="left" valign="top" style="border-bottom: solid 1px #eaeaea;"><?php
                                ...
                                ?></td>
                            <td align="left" valign="top" style="border-bottom: solid 1px #eaeaea;"><?php
                                if (isset($each_item['Item']['serialno'])) {
                                    echo $each_item['Item']['serialno'];
                                }
                                ?></td>
                            <td align="left" valign="top" style="border-bottom: solid 1px #eaeaea;"><?php
                            ...
                            <td align="left" valign="top" style="border-bottom: solid 1px #eaeaea;"><?php
                                ...
                                ?></td>
                            <td align="left" valign="top" style="border-bottom: solid 1px #eaeaea;"><?php
                                if (isset($each_item[0]['cost'])) {
                                    echo $each_item[0]['cost'];
                                }
                                ?></td>


                                <!--                    <td align="right" valign="top" style="border-bottom: solid 1px #eaeaea;"><?php
//        if (isset($each_item['Item']['unit_price'])) {
//           $total = $each_item['Item']['unit_price'] * $each_item['Item']['quantity']; 
//           echo $total;
//        }
                            ?></td>-->
                        </tr>
                    ...
                    foreach ($salestotal as $val):
                        ...
                        <tr style="background-color: #eaeaea;">
                            ...
                            <td align="left" valign="top" style="border-bottom: solid 1px #ffffff; background: #eaeaea; font-weight: bold;"><?php
                                ...
                                ?></td>
                            <td align="left" valign="top" style="border-bottom: solid 1px #ffffff; background: #eaeaea; font-weight: bold;"><?php
                                if (isset($val[0]['costp'])) {

                                    $cost = $val[0]['costp'];
                                    echo $shopCurrency . ' ' . $cost;
                                }
                                ?></td>
