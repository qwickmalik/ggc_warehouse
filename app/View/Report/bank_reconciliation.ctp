...
//        echo $this->Form->input('account_id', array('label' => 'Select Account*', 'options' => $accounts, 'empty' => '--Please select--', 'class' => 'form-control', 'div' => array('class' => 'form-inline'))); 
    ...
    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
        <?php 
        //echo $this->Form->button('Next', array("type" => "submit", "class" => "btn btn-md btn-primary")); 
        ?>
    </div>
            ...
            <td>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        ...
                        <p style='font-weight: bold; font-size: 16px; text-align: left;'><?php // echo $setup_results['Setting']['company_name'];           ?>BANK RECONCILIATION</p>
                        <p align='left'><?php echo $statement_date; ?></p>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
