            ...
            ?>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <?php 
                            echo $this->Form->input('department',array("label" => "User Department",)); 
...
//                            echo $this->Form->create('',array("url" => array('controller' => 'Users', 'action' => '#'),"inputDefaults" => array('label' => false,'div' => false)));
                    ...
                    <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td align="left"><?php echo $this->Html->link("Delete","/Users/deluserdep/".$each_item['Userdepartment']['id'], array('confirm' => 'Are you sure you want to delete?')); ?></td>
                            </tr>
                            <?php endforeach; ?>
                            <tr>
