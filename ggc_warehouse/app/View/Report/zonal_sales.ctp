...
<!-- Content starts here -->
    ...
    <table id="report_content" width="100%" align="left" cellspacing="0" cellpadding="5" border="0">
        <tr>
            <td colspan="7" align="left">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                    ...
                    <p style='font-weight: bold; font-size: 16px; text-align: left;'>ZONAL SALES REPORT <br /> from <?php echo $sdate; ?> - <?php echo $edate; ?></p>
                </div>
        ...
        <td align="left" valign="top" colspan="7">
            ...
            <?php echo $this->Form->create('OrdersItem', array("url" => array('controller' => 'Reports', 'action' => 'zonalSales'))); ?>
            <table cellspacing="10" cellpadding="0" width="100%" border="0" style="">

                <tr>
                    <td align="center">
                        <?php echo $this->Form->input('zone_id', array('empty' => '(All Zones)', 'label' => 'Zone*', 'style' => 'width: 100px;')); ?>
                    </td>
        ...
        <tr>
            ...
            <th align="left" valign="top" style="border-bottom: solid 2px Gray;"><?php echo $this->Paginator->sort('sales_person', 'Sales Person/Attendant'); ?></th>
...
<?php if (isset($accounts)) {
    ...
    foreach ($sales as $each_item):
        ...
        ?></td>
                    <td align="left" valign="top" style="border-bottom: solid 1px #eaeaea;"><?php
        if (isset($each_item['SalesItem']['unit_price'])) {
            $sale_total = $each_item['SalesItem']['quantity'] * $each_item['SalesItem']['unit_price'];
            echo  number_format($sale_total, 2,'.',',');
        }
        ?></td>
                </tr>
                    <?php endforeach;
        ...
        <?php if (isset($total) && isset($salestotal)) {
            foreach ($total as $each_item):
                ...
                if (isset($each_item[0]['tot_quat'])) {
                    
                $totquant = $each_item[0]['tot_quat'] + $val[0]['stot_quat'];
                    echo $totquant;
                }
                ?></td>
                    <td align="left" valign="top" style="border-bottom: solid 1px #ffffff; background: #eaeaea; font-weight: bold;">&nbsp;</td>
            ...
            foreach ($total as $each_item):
                ...
                ?></td>
                    ...
                    <?php 
                    endforeach;}elseif (isset($salestotal)){
            foreach ($salestotal as $each_item):
                ...
                <tr>
                    ...
                    <td align="left" valign="top" style="border-bottom: solid 1px #ffffff; background: #eaeaea; font-weight: bold;">&nbsp;</td>
                    <td align="left" valign="top" style="border-bottom: solid 1px #ffffff; background: #eaeaea; font-weight: bold;"><?php
                if (isset($each_item[0]['stot_quat'])) {
                    
                $totquant = $each_item[0]['stot_quat'];
                    echo $totquant;
                }
                ?></td>
                    <td align="left" valign="top" style="border-bottom: solid 1px #ffffff; background: #eaeaea; font-weight: bold;">&nbsp;</td>
