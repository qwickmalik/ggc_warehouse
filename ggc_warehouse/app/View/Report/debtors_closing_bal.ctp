...
<table id="report_content" width="100%" align="left" cellspacing="0" cellpadding="5" border="0">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                    ...
                    <p style='font-weight: bold; font-size: 16px; text-align: left;'>
                        DEBTORS' CLOSING BALANCES REPORT<br />from <?php echo $sdate; ?> - <?php echo $edate; ?>
                    </p>
                </div>
    ...
    <tr style="background: #eaeaea;" id="dateRow">
        ...
        <td align="left" valign="top" colspan="7">
            ...
            <?php echo $this->Form->create('debtorsClosingBal', array("url" => array('controller' => 'Reports', 'action' => 'debtorsClosingBal'))); ?>
                    ...
                    foreach ($accounts as $each_item):
                        ...
                        <tr>
                            ...
                            <td align="right" valign="top" style="border-bottom: solid 1px #eaeaea;"><?php
                                if (isset($each_item['ClosingBalance']['balance'])) {
                                    echo round($each_item['ClosingBalance']['balance'], 2);
                                }
                                ?></td>
                            <td align="right" valign="top" style="border-bottom: solid 1px #eaeaea;"> <?php echo $edate; ?></td>
                        </tr>
                        <?php
                    endforeach;
                }
